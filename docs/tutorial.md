...
In this program ([file](../examples/tutorial/calling_llm.yaml)), the `document` starts with the word `Hello,`, and we call a model (`ibm/granite-20b-code-instruct`) with this as input prompt. 
